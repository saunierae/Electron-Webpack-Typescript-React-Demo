...
*/
var aa=__webpack_require__(0),n=__webpack_require__(5),r=__webpack_require__(14);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));
...
if (false) { var secondaryBuildName, initialBuildName, buildNames, react_router_key, react_router_global; }
...
function history_createBrowserHistory(props) {
  ...
  !history_canUseDOM ?  false ? undefined : invariant(false) : void 0;
  var globalHistory = window.history;
...
// CONCATENATED MODULE: ./components/Utilities.tsx
// Output error to ensure proper usage
const assertNeverHit = (x) => {
    throw new Error("This line should not be hit.");
};

// CONCATENATED MODULE: ./components/JournalEntryComponent.tsx

// Create class for editing entries
class JournalEntryComponent_JournalEntryComponent extends react_default.a.Component {
    constructor() {
        super(...arguments);
        // Select the entry
    ...
    render() {
        return (react_default.a.createElement(react_default.a.Fragment, null,
            react_default.a.createElement("a", { onClick: this.onEntrySelected }, this.props.entry.name)));
    }
}

// CONCATENATED MODULE: ./components/JournalEntriesListComponent.tsx



// Create Class for Journal Entries View page
class JournalEntriesListComponent_JournalEntriesListComponent extends react_default.a.Component {
    constructor() {
        super(...arguments);
        // Create an empty journal entry for selected case
        this.createEmptyJournalEntry = () => {
            const sectionEntries = this.props.journal.sections.map(section => {
                const sectionEntry = {
    ...
    render() {
        ...
        const viewEntries = this.props.journal.journalEntries.map((entry, entryId) => {
            return react_default.a.createElement(react_default.a.Fragment, null,
                react_default.a.createElement("div", { className: "journalEntries" },
                    react_default.a.createElement(JournalEntryComponent_JournalEntryComponent, { key: entryId, journal: this.props.journal, journalId: this.props.journalId, entry: entry, entryId: entryId, entrySelected: this.props.entrySelected }),
                    react_default.a.createElement("button", { onClick: () => this.props.deleteEntry(this.props.journalId, entryId) }, "Delete")));
        });
        return (react_default.a.createElement("div", null,
            react_default.a.createElement("h1", null, this.props.journal.name),
            react_default.a.createElement("div", null,
                react_default.a.createElement("button", { className: "journals", onClick: e => this.props.addJournalEntry(this.props.journalId, this.createEmptyJournalEntry()) }, "Add Entry")),
            react_default.a.createElement("div", { className: "journalEntries" }, viewEntries),
            react_default.a.createElement("button", { className: "bottomRow", onClick: () => history.back() }, "Back")));
    }
}
/* harmony default export */ var components_JournalEntriesListComponent = (JournalEntriesListComponent_JournalEntriesListComponent);

// EXTERNAL MODULE: ./components/Styles.css
var Styles = __webpack_require__(16);

// EXTERNAL MODULE: ../node_modules/bootstrap/dist/css/bootstrap.min.css
var bootstrap_min = __webpack_require__(18);

// CONCATENATED MODULE: ./components/EditSection.tsx

// Create class to edit the section
class EditSection_EditSection extends react_default.a.Component {
    constructor() {
        super(...arguments);
        // Edit the section name with user input
        this.editSectionName = (e) => {
    ...
    render() {
        return (react_default.a.createElement("div", null,
            react_default.a.createElement("input", { value: this.props.section.name, onChange: this.editSectionName })));
    }
}

// CONCATENATED MODULE: ./components/EditItem.tsx

// Create the class to edit items
class EditItem_EditItem extends react_default.a.Component {
    constructor() {
        super(...arguments);
    ...
    render() {
        return (react_default.a.createElement("div", null,
            react_default.a.createElement("input", { value: this.props.item.label, onChange: this.editItemName })));
    }
}

// CONCATENATED MODULE: ./components/EditJournalTemplateComponent.tsx
        ...
        const viewSections = this.props.journal.sections.map((section, sectionId) => {
            ...
            const items = section.items.map((item, itemId) => {
                return react["createElement"]("div", { className: "item" },
                    " ",
                    react["createElement"](EditItem_EditItem, { key: itemId, sectionId: sectionId, itemId: itemId, item: item, editItemName: this.editItemName }));
            });
            return react["createElement"](react["Fragment"], null,
                react["createElement"]("div", { className: "section" },
                    react["createElement"](EditSection_EditSection, { key: sectionId, sectionId: sectionId, section: section, editSectionName: this.editSectionName }),
                    react["createElement"]("button", { onClick: () => this.props.deleteSection(this.props.journalId, sectionId) }, "Delete"),
                    react["createElement"]("button", { onClick: () => this.props.additem(this.props.journalId, sectionId) }, "Add Item"),
                    items));
        });
        // Always display the following
        return (react["createElement"]("div", null,
            react["createElement"]("h1", null, "Create Sections and Items for the Journal"),
            react["createElement"]("div", { className: "instructions" },
                react["createElement"]("ol", null,
                    react["createElement"]("li", null, "Select Drop Down for the desired section type"),
                    react["createElement"]("li", null, "Click add sections"),
                    react["createElement"]("li", null, "Label the section"),
                    react["createElement"]("li", null, "Click add item for the section"),
                    react["createElement"]("li", null, "Label the item"),
                    react["createElement"]("li", null, "To add more sections, repeat the above steps until the desired journal is completed"),
                    react["createElement"]("li", null, "Select the \"Complete Journal Template to finialize the journal\" then select return"),
                    react["createElement"]("p", null, "Note: The sectons will need to ahve a matching input for all types, otherwise you will want to create a new section"))),
            react["createElement"]("div", null,
                react["createElement"]("form", { className: "selection" },
                    react["createElement"]("select", { value: this.state.sectionType, onChange: this.onChangeSectionType, id: "type" },
                        react["createElement"]("option", { value: "checkbox" }, "Checkbox"),
                        react["createElement"]("option", { value: "freeform" }, "Freeform")))),
            react["createElement"]("div", { className: "sectionButton" },
                react["createElement"]("button", { onClick: () => this.props.addSection(this.props.journalId, this.state.sectionType) }, "Add Section")),
            react["createElement"]("div", { className: "sectionItems" }, viewSections),
            react["createElement"]("div", null,
                react["createElement"]("button", { className: "complete", onClick: this.onFinalizeJournal }, "Complete Journal Template")),
            react["createElement"]("div", null,
                react["createElement"]("button", { className: "bottomRow", onClick: () => history.back() }, "Return"))));
    }
}

// CONCATENATED MODULE: ./components/EditJournal.tsx

// Create a class to edit the journal
class EditJournal_EditJournal extends react_default.a.Component {
    constructor() {
        super(...arguments);
        // Edit the journal name by taking in the value for selected journal
        this.editJournalName = (e) => {
    ...
    render() {
        ...
        const journalName = this.props.journal.finalized ?
            react_default.a.createElement("a", { onClick: this.onJournalSelected }, this.props.journal.name) :
            react_default.a.createElement("input", { value: this.props.journal.name, onChange: this.editJournalName });
        return (react_default.a.createElement(react_default.a.Fragment, null, journalName));
    }
}

// CONCATENATED MODULE: ./components/JournalTemplateListComponent.tsx


//Create the class for Journal Template
class JournalTemplateListComponent_JournalTemplateListComponent extends react["Component"] {
    constructor() {
        super(...arguments);
        //edit journal name for selected journal
        this.editJournalName = (journalId, value) => {
    ...
    render() {
        ...
        const journals = this.props.journals.map((journal, journalId) => {
            ...
            const editButton = journal.finalized ?
                null :
                react["createElement"]("button", { onClick: () => this.props.editJournal(journalId) }, "Edit");
            return react["createElement"](react["Fragment"], null,
                react["createElement"]("div", { className: "journals" },
                    react["createElement"](EditJournal_EditJournal, { key: journalId, journalId: journalId, journal: journal, editJournalName: this.editJournalName, journalSelected: this.props.journalSelected }),
                    react["createElement"]("button", { onClick: () => this.props.deleteJournal(journalId) }, "Delete"),
                    editButton));
        });
        // Always show the following options
        return (react["createElement"]("div", null,
            react["createElement"]("h1", null, "Current Journals"),
            journals,
            react["createElement"]("button", { className: "top1", onClick: e => this.props.addJournal() }, "Create Journal Template"),
            react["createElement"]("button", { className: "top2", onClick: e => this.props.onTutorialSelected() }, "View Tutorial"),
            react["createElement"]("button", { className: "bottomRow", onClick: () => history.back() }, "Back")));
    }
}
/* harmony default export */ var components_JournalTemplateListComponent = (JournalTemplateListComponent_JournalTemplateListComponent);
...
function Tutorial() {
    return (react["createElement"]("div", null,
        ...
        react["createElement"]("ol", null,
            ...
            react["createElement"]("li", null, "Select the \"Complete Journal Template to finialize the journal\" then select return"),
            react["createElement"]("p", null, "Note: The sectons will need to ahve a matching input for all types, otherwise you will want to create a new section")),
        react["createElement"]("img", { src: "tutorialImage.png", className: "Example", alt: "Example" }),
        react["createElement"]("button", { className: "bottomRow", onClick: () => history.back() }, "Back")));
}
/* harmony default export */ var components_Tutorial = (Tutorial);

// EXTERNAL MODULE: external "electron"
var external_electron_ = __webpack_require__(3);

// CONCATENATED MODULE: ./components/AppState.tsx
//Finalize the journal
const finalizeJournal = (appState, journalId) => {
    const newJournal = Object.assign(Object.assign({}, appState.journals[journalId]), { finalized: true });
    return updateJournal(appState, journalId, newJournal);
};
//Create Journals
const addJournal = (appState, journal) => {
    return { journals: [...appState.journals, journal] };
};
//Add Journal Entry
const addJournalEntry = (appState, journalId, entryInfo) => {
    const newEntries = [...appState.journals[journalId].journalEntries, entryInfo];
    const newJournal = Object.assign(Object.assign({}, appState.journals[journalId]), { journalEntries: newEntries });
    return updateJournal(appState, journalId, newJournal);
};
//Delete Journals
const deleteJournal = (appState, journalId) => {
    const newJournals = [...appState.journals];
    newJournals.splice(journalId, 1);
    return { journals: newJournals };
};
//Delete Journals
const deleteEntry = (appState, journalId, entryId) => {
...
const updateJournal = (appState, journalId, journal) => {
    const newJournals = [...appState.journals];
    newJournals[journalId] = journal;
    return Object.assign(Object.assign({}, appState), { journals: newJournals });
};
//Reusable code2
//Helper function to update sections
const updateSection = (appState, journalId, sectionId, section) => {
    const newSections = [...appState.journals[journalId].sections];
    newSections[sectionId] = section;
    const newJournal = Object.assign(Object.assign({}, appState.journals[journalId]), { sections: newSections });
    return updateJournal(appState, journalId, newJournal);
};
//Reusable code 3
//Helper function to update items
const updateItem = (appState, journalId, sectionId, itemId, item) => {
    const newItems = [...appState.journals[journalId].sections[sectionId].items];
    newItems[itemId] = item;
    const newSection = Object.assign(Object.assign({}, appState.journals[journalId].sections[sectionId]), { items: newItems });
    return updateSection(appState, journalId, sectionId, newSection);
};
//Reusable code 4
// Helper function to update sections
const updateEntry = (appState, journalId, entryId, entry) => {
    const newEntries = [...appState.journals[journalId].journalEntries];
...
//Delete sections
const deleteSection = (appState, journalId, sectionId) => {
    const newSections = [...appState.journals[journalId].sections];
...
//Delete items
const deleteItem = (appState, journalId, sectionId, itemId) => {
    const newItems = [...appState.journals[journalId].sections[sectionId].items];
    newItems.splice(itemId, 1);
    const newSections = Object.assign(Object.assign({}, appState.journals[journalId].sections[sectionId]), { items: newItems });
    return updateSection(appState, journalId, sectionId, newSections);
};
//Edit the Journal Name 
const editJournalName = (appState, journalId, value) => {
    const newJournal = Object.assign(Object.assign({}, appState.journals[journalId]), { name: value });
    return updateJournal(appState, journalId, newJournal);
};
//Add new section with section info
const addSection = (appState, journalId, sectionInfo) => {
    const newSections = [...appState.journals[journalId].sections, sectionInfo];
    const newJournal = Object.assign(Object.assign({}, appState.journals[journalId]), { sections: newSections });
    return updateJournal(appState, journalId, newJournal);
};
//Add new item with item info
const addItem = (appState, journalId, sectionId, item) => {
    const newItems = [...appState.journals[journalId].sections[sectionId].items, item];
    const newSection = Object.assign(Object.assign({}, appState.journals[journalId].sections[sectionId]), { items: newItems });
    return updateSection(appState, journalId, sectionId, newSection);
};
//Edit Item name
const editItemName = (appState, journalId, sectionId, itemId, value) => {
    const newItem = Object.assign(Object.assign({}, appState.journals[journalId].sections[sectionId].items[itemId]), { label: value });
    return updateItem(appState, journalId, sectionId, itemId, newItem);
};
//Edit entry data
const updateEntryValue = (appState, journalId, journalEntryId, sectionEntryId, entryItemId, value) => {
    const newItems = [...appState.journals[journalId].journalEntries[journalEntryId].sectionEntries[sectionEntryId].itemEntries];
    newItems[entryItemId] = value;
    const newSections = [...appState.journals[journalId].journalEntries[journalEntryId].sectionEntries];
    newSections[sectionEntryId] = Object.assign(Object.assign({}, newSections[sectionEntryId]), { itemEntries: newItems });
    const newEntryValue = Object.assign(Object.assign({}, appState.journals[journalId].journalEntries[journalEntryId]), { sectionEntries: newSections });
    return updateEntry(appState, journalId, journalEntryId, newEntryValue);
};
//Edit Section Name
const editSectionName = (appState, journalId, sectionId, value) => {
    const newSection = Object.assign(Object.assign({}, appState.journals[journalId].sections[sectionId]), { name: value });
    return updateSection(appState, journalId, sectionId, newSection);
};

// CONCATENATED MODULE: ./components/EditJournalEntryComponent.tsx

// Create class View journal entries
class EditJournalEntryComponent_EditJournalEntryComponent extends react["Component"] {
    render() {
        ...
        const journalSections = journalEntry.sectionEntries.map((sectionEntry, sectionEntryIndex) => {
            ...
            const items = sectionEntry.itemEntries.map((item, itemEntryIndex) => {
                ...
                const itemInput = sectionType === "checkbox" ?
                    react_default.a.createElement("input", { type: "checkbox", className: "checkbox", checked: this.props.journal.journalEntries[this.props.entryId].sectionEntries[sectionEntryIndex].itemEntries[itemEntryIndex], onChange: e => this.props.updateEntryValue(this.props.journalId, this.props.entryId, sectionEntryIndex, itemEntryIndex, e.target.checked) }) :
                    react_default.a.createElement("div", null,
                        react_default.a.createElement("input", { type: "text", className: "textInput", value: this.props.journal.journalEntries[this.props.entryId].sectionEntries[sectionEntryIndex].itemEntries[itemEntryIndex], onChange: e => this.props.updateEntryValue(this.props.journalId, this.props.entryId, sectionEntryIndex, itemEntryIndex, e.target.value) }));
                return (react_default.a.createElement("div", { key: itemEntryIndex },
                    itemName,
                    itemInput));
            });
            return (react_default.a.createElement("div", { key: sectionEntryIndex },
                sectionName,
                items));
        });
        return (react_default.a.createElement("div", null,
...
/* harmony default export */ var components_EditJournalEntryComponent = (EditJournalEntryComponent_EditJournalEntryComponent);

// CONCATENATED MODULE: ./components/Routes.tsx
...
class Routes_Routes extends react["Component"] {
    constructor(props) {
        super(props);
        ...
        this.addJournalEntry = (journalId, entry) => {
            this.updateAppState(addJournalEntry(this.state.appState, journalId, entry));
        };
        // State for updating the entry
        this.updateEntryValue = (journalId, entryId, sectionEntryId, entryItemId, value) => {
        ...
        this.editJournalName = (journalId, name) => {
        ...
        this.updateAppState = (state) => {
            external_electron_["ipcRenderer"].sendSync('save', ['data.json', JSON.stringify(Object.assign(Object.assign({}, this.state.appState), state))]);
            this.setState({ appState: state });
        };
        // State for finalize journal
        this.onFinalizeJournal = (journalId) => {
        ...
        this.onJournalSelected = (journalId) => {
            window.location.hash = "/JournalEntries";
            this.setState({ journalId: journalId });
            this.forceUpdate();
        };
        // Display the entry selected
        this.onEntrySelected = (journalId, entryId) => {
        ...
        this.state = {
            appState: external_electron_["ipcRenderer"].sendSync('read', "data.json")
        };
    }
    // Render the routes
    render() {
        ...
        return (react["createElement"]("div", null,
            react["createElement"](react_router_dom_HashRouter, null,
                react["createElement"](react_router_Switch, null,
                    react["createElement"](react_router_Route, { path: "/EditJournalForm" },
                        react["createElement"](EditJournalTemplateComponent_EditJournalTemplateComponent, { journal: this.state.appState.journals[this.state.journalId], journalId: this.state.journalId, addSection: this.addSection, additem: this.addItem, deleteSection: this.deleteSection, editSectionName: this.editSectionName, editItemName: this.editItemName, deleteItem: this.deleteItem, onFinalizeJournal: this.onFinalizeJournal })),
                    react["createElement"](react_router_Route, { path: "/Tutorial" },
                        react["createElement"](components_Tutorial, null)),
                    react["createElement"](react_router_Route, { path: "/JournalEntries" },
                        react["createElement"](JournalEntriesListComponent_JournalEntriesListComponent, { journal: this.state.appState.journals[this.state.journalId], journalId: this.state.journalId, deleteEntry: this.deleteEntry, addJournalEntry: this.addJournalEntry, entrySelected: this.onEntrySelected })),
                    react["createElement"](react_router_Route, { path: "/ViewJournalEntry" },
                        react["createElement"](components_EditJournalEntryComponent, { journal: this.state.appState.journals[this.state.journalId], journalId: this.state.journalId, entryId: this.state.entryId, updateEntryValue: this.updateEntryValue })),
                    react["createElement"](react_router_Route, { path: "/" },
                        react["createElement"](components_JournalTemplateListComponent, { journals: this.state.appState.journals, journal: this.state.appState.journals[this.state.journalId], journalId: this.state.journalId, addJournal: this.addJournal, deleteJournal: this.deleteJournal, editJournalName: this.editJournalName, editJournal: this.editJournal, journalSelected: this.onJournalSelected, onTutorialSelected: this.onTutorialSelected }))))));
    }
}
...
Object(react_dom["render"])(
// <App/>,
react["createElement"](react["Fragment"], null,
    react["createElement"]("div", null, ""),
    react["createElement"](Routes_Routes, null)), rootEl);
